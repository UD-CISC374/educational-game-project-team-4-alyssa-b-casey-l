...
export default class orderScene6 extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(60,100, "fraise",{fill:"#000000", fontSize:"40px"});
    this.add.text(60,150, "poulette",{fill:"#000000", fontSize:"40px"});
    this.add.text(60,200, "jambon",{fill:"#000000", fontSize:"40px"});
 ...
 this.physics.add.overlap(this.bag, this.tomato, this.orderBag, undefined, this);
  ...
  orderBag(bag, food){
    ...
    if(this.score == 150){ //array.length returns one number higher than the highest index. for some reason
