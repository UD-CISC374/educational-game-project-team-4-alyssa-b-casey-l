...
export default class orderScene3 extends Phaser.Scene {
  ...
  create() {
    ...
    this.checkmark2 = this.add.image(55, 250, "checkmark").setVisible(false);
    this.checkmark2.setScale(0.15);
    this.checkmark3 = this.add.image(55, 300, "checkmark").setVisible(false);
    this.checkmark3.setScale(0.15);
    this.checkmark4 = this.add.image(55, 200, "checkmark").setVisible(false);
    this.checkmark4.setScale(0.15);
    this.checkmark5 = this.add.image(55, 150, "checkmark").setVisible(false);
