...
export default class orderScene8 extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(60,100, "cafe (coffee)",{fill:"#000000", fontSize:"40px"});
    this.add.text(60,250, "ananas \n(pineapple)",{fill:"#000000", fontSize:"40px"});
    this.add.text(60,150, "banane (banana)",{fill:"#000000", fontSize:"40px"});
    //this.add.text(60,250, "salade",{fill:"#000000", fontSize:"40px"});
    this.add.text(60,200, "fromage (cheese)",{fill:"#000000", fontSize:"40px"});
